...
> **Note:** Entries below (0.0.2 — 0.0.45) were auto-generated by a legacy
> release script that has since been removed. For release notes from
> 0.0.47 onward, see the [GitHub Releases page](https://github.com/jina-ai/jina-sagemaker/releases).
> This file is preserved as a historical record and is no longer updated.
